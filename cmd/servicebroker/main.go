...
func init() {
	flag.BoolVar(&options.RunBackgroundTasks, "background-tasks", false, "use '--background-tasks' option to startup broker in worker mode that just processes queued tasks.")
